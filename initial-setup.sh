print("get up to date packages with apt-get")
sudo apt-get update
sudo apt-get -y upgrade

print("install new packages - various stuff to run weeder script")
...
print("use pip to install packages into python")
pip3 install opencv-python
pip3 install --upgrade tflite-support==0.4.2
pip3 install --upgrade tflite-runtime==2.11.0
pip3 install imutils

print("get pigpio daemon running so we have better servo control")
...
print("set up iptables and rules")
...
print("set up dnsmask to do dns resolution on our wifi hotspot")
...
#TO DO: add to crontab - python3 -m flask --app ~/weeder/webgui.py run --host=0.0.0.0
print("create entry in crontab to always run weeder app on startup")

print("Install flask and associated forms packages")
